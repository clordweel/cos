/**
 * COS patch: Replace erpnext.utils.update_child_items to use child doctype's rate fieldtype
 * (from frappe.get_meta) instead of hardcoded Currency.
 * When rate is Float (via property setter), Update Items dialog shows rate as Float.
 */
(function () {
	...
	erpnext.utils.update_child_items = function (opts) {
		...
		// COS: Use child doctype's rate fieldtype (Float vs Currency) from meta
