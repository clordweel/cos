...
"""从 print_format/stock-entry-standard 同步模板到 Print Format「物料移动 - 标准」。

用法:
  bench --site junhai.local execute cos.scripts.sync_stock_entry_print_format.sync
"""
...
def _get_print_format_dir() -> Path:
	...
	return app_root / "print_format" / "stock-entry-standard"
