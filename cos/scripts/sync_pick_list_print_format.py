...
"""从 print_format/pick-list-standard 同步模板到 Print Format「拣货单 - 标准」。

用法:
  bench --site junhai.local execute cos.scripts.sync_pick_list_print_format.sync
"""
...
def _get_print_format_dir() -> Path:
	...
	return app_root / "print_format" / "pick-list-standard"
