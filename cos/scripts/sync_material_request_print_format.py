...
"""从 print_format/material-request-standard 同步模板到 Print Format「物料需求 - 标准」。

用法:
  bench --site junhai.local execute cos.scripts.sync_material_request_print_format.sync
"""
...
def _get_print_format_dir() -> Path:
	...
	return app_root / "print_format" / "material-request-standard"
